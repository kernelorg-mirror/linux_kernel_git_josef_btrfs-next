...
//		printk(KERN_ERR "adding extent %Lu to %Lu\n", ordered->file_offset,
...
void btrfs_wait_logged_extents(struct btrfs_root *log, u64 transid)
{
	...
	while (!list_empty(&log->logged_list[index])) {
		ordered = list_first_entry(&log->logged_list[index],
					   ...
					   log_list);
//		printk(KERN_ERR "waiting extent %Lu to %Lu, disk %Lu to %Lu\n", ordered->file_offset,
//		       ordered->file_offset + ordered->len, ordered->start, ordered->start + ordered->len);
