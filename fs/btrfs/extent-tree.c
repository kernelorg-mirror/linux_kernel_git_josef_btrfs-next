 ...
 * @limit - the maximum amount to refill.
 * @flush - control how we can flush for this reservation.
 *
 * This will refill the delayed block_rsv up to the given limit or return
 * -ENOSPC if we can't make the reservation.
 */
int btrfs_refill_delayed_block_rsv(struct btrfs_fs_info *fs_info, u64 limit,
				   enum btrfs_reserve_flush_enum flush)
{
